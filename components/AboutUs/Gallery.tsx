      ...
      <div className={styles.gallery__center}>
        ...
        <div className={styles.carousel}>
          {images.map((image, index) => (
            <div
              key={index}
              className={`${styles.carousel__container} ${getCurrentClassNames(index)}`}
            >
              <img
                src={image.src}
        ...
        <div className={styles.gallery__name}>{images[currentIndex].title}</div>
        <div className={styles.gallery__date}>{images[currentIndex].date}</div>
      </div>
