...
const HomeLogo = ({style} : {style? : any}) => {
    ...
    const handleMouseLeave = () => {
        ...
        if (logoRef.current && logoRef2.current) {
    ...
    return (
        <div style={style} className={styles.logoContContainer} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
            ...
            <div ref={logoRef2} className={styles.logoContainer2}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" height="100%" width="100%">
                    <mask id="svgmask1">
                        <mask id="svgmask2">
                            <polygon points="150,58 0,164 0,0 300,0 300,164" height="100%" width="100%" fill="white"/>
                    ...
                    <image mask="url(#svgmask1)" width="110%" x="-6%" y="4.5%" href="/Home/home_logo/polygons_bg_blue.png"/>
                </svg>
            </div>
        </div>
    );
