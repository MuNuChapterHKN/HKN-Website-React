  ...
  return (
    <div className={styles.footer}>
      <div className={styles.columnLogo}>
        <img
          className={styles.columnLogo__logopolito}
      ...
      <div className={styles.column}>
        ...
        <div className={styles.column__subtitle}>
        ...
        <div className={styles.links}>
          ...
          <LinkIcon
            ...
            link="https://www.youtube.com/channel/UCEPeZOBv08kO2ImbjgM7yBw"
          />
          <LinkIcon src="/Icons/twitter.png" link="https://twitter.com/HKNPoliTo" />
          <LinkIcon
            src="/Icons/spotify.png"
            link="https://open.spotify.com/show/4MMAaLMKiyUI0jcrxZjH2s?si=0YvAwZVSTAqCLxSQRwp81w&nd=1"
          />
          <LinkIcon
            src="/Icons/linkedin.png"
            link="https://www.linkedin.com/company/mu-nu-chapter-of-ieee-eta-kappa-nu"
          />
        </div>
      </div>
      ...
      <div className={styles.columnLogo}>
        <a href="https://hkn.ieee.org/">
          <img
            className={styles.columnLogo__logokhn}
            src="/Common/hkn_logo_society.png"
            alt="HKN Logo"
          />
        </a>
      </div>
