    ...
    <>
      <div className={styles.topbar}>
        <div className={styles.topbarInner}>
          <div className={styles.langSwitch}>
            <button
              className={`${styles.langButton} ${isLangActive('it') ? styles.langButtonActive : ''}`}
            ...
            <button
              className={`${styles.langButton} ${isLangActive('en') ? styles.langButtonActive : ''}`}
      ...
      <header className={`${styles.header} ${navbarOpen ? styles.open : ''}`}>
        ...
        <div className={`${styles.menu} ${navbarOpen ? styles.open : ''}`}>
          ...
          <div
            className={`${isActive('/People/People') || isActive('/People/Alumni') || isActive('/People/Professionals') || isActive('/People/PastBoards') ? styles.active : styles.inactive} ${styles.menuItem}`}
          >
            ...
            <ul className={styles.dropdown}>
              <li
                className={isActive('/People/People') ? styles.activeDropdown : ''}
              ...
              <li
                className={isActive('/People/Alumni') ? styles.activeDropdown : ''}
                onClick={(e: React.MouseEvent<Element, MouseEvent>) =>
              ...
              <li
                className={isActive('/People/Professionals') ? styles.activeDropdown : ''}
                onClick={(e: React.MouseEvent<Element, MouseEvent>) =>
              ...
              <li
                className={isActive('/People/PastBoards') ? styles.activeDropdown : ''}
                onClick={(e: React.MouseEvent<Element, MouseEvent>) =>
          ...
          <div
            className={isActive('/Activities/Events') ? styles.active : styles.inactive}
          ...
          <div
            className={isActive('/Activities/StudyGroups') ? styles.active : styles.inactive}
          ...
          <div
            className={isActive('/Publications/Recognitions') ? styles.active : styles.inactive}
