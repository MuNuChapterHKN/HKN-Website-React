    ...
    <>
      <header className={styles.header}>
        ...
        <div className={styles.menu}>
          ...
          <div
            className={isActive("/AboutUs") ? styles.active : styles.inactive}
          ...
          <div
            className={`${isActive("/People/People") ||
              isActive("/People/Alumni") ||
              isActive("/People/Professionals") ||
              isActive("/People/PastBoards")
              ? styles.active
              : styles.inactive
              } ${styles.menuItem}`}
          ...
          >
            ...
            <ul className={styles.dropdown}>
              <li
                className={
                  isActive("/People/People")
                    ? styles.activeDropdown
                    : ""
                }
                onClick={(e) => handleNavigate(e, "/People/People")}
              >
              ...
              <li
                ...
                onClick={(e) => handleNavigate(e, "/People/Alumni")}
              >
          ...
          <div
            className={
              isActive("/Activities/StudyGroups")
                ? styles.active
                : styles.inactive
            }
            onClick={() =>
          ...
          <div
            className={
              isActive("/Publications/Recognitions")
                ? styles.active
                : styles.inactive
            }
            onClick={() =>
      ...
      <div
        className={`${styles.mobileOverlay} ${navbarOpen ? styles.open : ""
          }`}
      >
        <nav className={styles.mobileNav}>
          <div onClick={() => { router.push("/"); toggleNavbar(false); }}>
            <T keyName="header.nav.home" />
          </div>

          <div onClick={() => { router.push("/AboutUs"); toggleNavbar(false); }}>
            <T keyName="header.nav.about" />
          </div>

          <div onClick={() => { router.push("/People/People"); toggleNavbar(false); }}>
            <T keyName="header.nav.people.main" />
          </div>

          <div onClick={() => { router.push("/Activities/Events"); toggleNavbar(false); }}>
            <T keyName="header.nav.events" />
          </div>

          <div onClick={() => { router.push("/Activities/StudyGroups"); toggleNavbar(false); }}>
            <T keyName="header.nav.study_groups" />
          </div>

          <div onClick={() => { router.push("/Publications/Recognitions"); toggleNavbar(false); }}>
            <T keyName="header.nav.publications" />
          </div>

          <div onClick={() => { router.push("/JoinUs"); toggleNavbar(false); }}>
            <T keyName="common.join_us" />
          </div>
        </nav>
      </div>
