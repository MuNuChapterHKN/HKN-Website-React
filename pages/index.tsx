    ...
    <Layout triangles>
      <div className={styles.titleContainer}>
        <div className={styles.titleColumn}>
          <span className={styles.drivenByPassion}>
            <T keyName="home.title.dbp" />
          </span>
          <span className={styles.drivenByPassion}>
            <T keyName="home.title.gbv" />
          </span>
          ...
          <div className={styles.titleButtons}>
            <RoundButton
              className={styles.joinUsTitleButton}
              onClick={() => router.push('/JoinUs')}
            >
              <T keyName="common.join_us" />
            </RoundButton>
            <RoundButton
              className={styles.aboutUsTitleButton}
      ...
      <div className={styles.visionContainer}>
        <div className={styles.visionLeft}>
          <span className={styles.visionText}>
            <T keyName="home.vision.kicker" />
          </span>
          <span className={styles.visionTitle}>
            <T keyName="home.vision.title" />
          </span>
          ...
          <div className={styles.visionButtons}>
            <RoundButton
              className={styles.peopleVisionButton}
              onClick={() => router.push('/AboutUs#vision')}
            >
              <T keyName="common.read_me" />
            </RoundButton>
            <RoundButton
              className={styles.galleryVisionButton}
      ...
      <div className={styles.originsContainer}>
        <Image
          ...
          src="/Home/origins.jpg"
          alt={t('home.origins.alt')}
          width="0"
          height="0"
          sizes="100vw"
        />
        <div className={styles.originsRight}>
          <span className={styles.originsText}>
            <T keyName="home.origins.kicker" />
          </span>
          <span className={styles.originsTitle}>
            <T keyName="home.origins.title" />
          </span>
          ...
          <div className={styles.originsButtons}>
            <RoundButton
              className={styles.readMeOriginsButton}
              onClick={() => router.push('/AboutUs#origin')}
            >
              <T keyName="common.read_me" />
            </RoundButton>
          </div>
        ...
        <Image
          className={styles.originsImageMobile}
          src="/Home/origins.jpg"
          alt={t('home.origins.alt')}
          width="0"
          height="0"
          ...
          <div className={activities_styles.allActivities__columns}>
            <div className={activities_styles.allActivities__columns__left}>
              <div className={activities_styles.allActivities__group1}>
                <div className={activities_styles.allActivities__group__events}>
                  <T keyName="home.activities.group1_kicker" />
                </div>
                <div className={activities_styles.allActivities__group__title}>
                  <T keyName="home.activities.group1_title" />
                </div>
                ...
                <div className={activities_styles.allActivities__group1__imgcont1}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Events/mentalWellnessDigitalWellBeing.png'}
                    alt={t('home.activities.event_3_alt')}
                  />
                </div>
                <div className={activities_styles.allActivities__group1__imgcont2}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Events/event_2022.png'}
                    alt={t('home.activities.event_2_alt')}
                ...
                <div className={activities_styles.allActivities__group1__imgcont3}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Events/quantumQuest.png'}
                    alt={t('home.activities.event_1_alt')}
                  />
                </div>
                ...
                <div className={activities_styles.allActivities__group1__discover}>
                  ...
                  <RoundButton
                    className={activities_styles.allActivities__group__button}
              ...
              <div className={activities_styles.allActivities__group2}>
                <div className={activities_styles.allActivities__group__events}>
                  <T keyName="home.activities.group2_kicker" />
                </div>
                <div className={activities_styles.allActivities__group__title}>
                  <T keyName="home.activities.group2_title" />
                </div>
                <div className={activities_styles.allActivities__group__text}>
                ...
                <div className={activities_styles.allActivities__group2__imgcont1}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/MentalWellness.jpg'}
                    alt={t('home.activities.discover_1_alt')}
                  />
                </div>
                <div className={activities_styles.allActivities__group2__imgcont2}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/Hexakappathlon.jpg'}
                    alt={t('home.activities.discover_2_alt')}
                    style={{ objectPosition: '75% 100%' }}
                  />
                </div>
                <div className={activities_styles.allActivities__group2__imgcont3}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/FoundersDay.jpg'}
                    alt={t('home.activities.discover_1_alt')}
                  />
                </div>
                ...
                <div className={activities_styles.allActivities__group2__discover}>
                  <T keyName="common.discover" />
                  <RoundButton className={activities_styles.allActivities__group__button}>
            ...
            <div className={activities_styles.allActivities__columns__right}>
              <div className={activities_styles.allActivities__group3}>
                <div className={activities_styles.allActivities__group__events}>
                  <T keyName="home.activities.group3_kicker" />
                </div>
                <div className={activities_styles.allActivities__group__title}>
                  <T keyName="home.activities.group3_title" />
                </div>
                <div className={activities_styles.allActivities__group__text}>
                ...
                <div className={activities_styles.allActivities__group3__imgcont1}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/Discover_2.jpeg'}
                    alt={t('home.activities.discover_1_alt')}
                  />
                </div>
                <div className={activities_styles.allActivities__group3__imgcont2}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/FormazioneInternaReply.jpeg'}
                    alt={t('home.activities.discover_2_alt')}
                    style={{ objectPosition: '75% 100%' }}
                  />
                </div>
                <div className={activities_styles.allActivities__group3__imgcont3}>
                  <img
                    className={activities_styles.allActivities__group__img}
                    src={'/Activities/Activities/Discover_3.jpeg'}
                    alt={t('home.activities.discover_1_alt')}
                  />
                </div>
      ...
      <div className={styles.applyCard}>
        <span className={styles.textAreYouReady}>
          <T keyName="home.apply.kicker" />
        </span>
        <span className={styles.textJoinOurChapter}>
          <T keyName="home.apply.title_1" />
        </span>
        <span className={styles.textJoinOurChapter}>
          <T keyName="home.apply.title_2" />
        </span>
        <RoundButton
          className={`darkButton ${styles.buttonJoinUs}`}
          onClick={() => router.push('/JoinUs')}
        >
          <T keyName="common.join_us" />
        </RoundButton>
