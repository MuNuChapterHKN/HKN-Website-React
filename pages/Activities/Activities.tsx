    ...
    <Layout darkHeader>
      <div className={styles.latestActivitiesBackground}>
        <div className={styles.latestActivities}>
          <div
            className={styles.latestActivities__left}
            onClick={() => router.push('/Activities/Events#QuantumQuest')}
          >
            <div className={styles.latestActivities__left__title}>Latest Activities</div>

            <div className={styles.latestActivities__left__card}>
              <div className={styles.latestActivities__left__card__imageContainer}>
                <img
                  className={styles.latestActivities__left__card__image}
          ...
          <div className={styles.latestActivities__right}>
            <div className={styles.latestActivities__right__masterclass}>
              <div className={styles.latestActivities__right__card__imageContainer}>
                <img
                  className={styles.latestActivities__right__card__image}
                  src={'/Activities/Masterclasses/masterclass2-3.jpeg'}
                  alt={'latest'}
                />
              </div>
            ...
            <a
              className={styles.latestActivities__right__studyGroup}
              onClick={() => router.push('/Activities/StudyGroups')}
            >
              <div className={styles.latestActivities__right__card__imageContainer}>
                <img
                  className={styles.latestActivities__right__card__image}
                  src={'/Activities/Activities/Activities.png'}
                  alt={'latest'}
                />
              </div>
      ...
      <div className={styles.allActivities}>
        ...
        <div className={styles.allActivities__content}>
          <div className={styles.allActivities__events}>events</div>
          <div className={styles.allActivities__title}>Discover All Our Activities</div>
          ...
          <div className={styles.allActivities__columns}>
            <div className={styles.allActivities__columns__left}>
              <div className={styles.allActivities__group1}>
                ...
                <div className={styles.allActivities__group__text}>
                  Our events are thought for anyone who likes talking, debating, learning and
                  discovering
                </div>

                <div className={styles.allActivities__group1__imgcont1}>
                  <img
                    className={styles.allActivities__group__img}
                ...
                <div className={styles.allActivities__group1__discover}>
                  Discover
                  <RoundButton
                    className={styles.allActivities__group__button}
              ...
              <div className={styles.allActivities__group2}>
                ...
                <div className={styles.allActivities__group__text}>
                  Our experts will provide you advices and tips that will help you improving your
                  skills & enriching your CV
                </div>
                ...
                <div className={styles.allActivities__group2__discover}>
                  Discover
                  <RoundButton className={styles.allActivities__group__button}>
                    COMING SOON
                  </RoundButton>
                </div>
              </div>
            ...
            <div className={styles.allActivities__columns__right}>
              <div className={styles.allActivities__group3}>
                ...
                <div className={styles.allActivities__group__text}>
                  HKN members and PhD students will help you with whatever concept you might be
                  struggling with
                </div>
