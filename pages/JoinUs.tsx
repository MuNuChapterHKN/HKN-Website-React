...
const APPLY_URL =
  process?.env?.NEXT_PUBLIC_HKRECRUITMENT_APPLY_URL ??
  'https://recruitment.hknpolito.org/recruitment/apply';
      ...
      <main className={styles.container}>
        <section>
          <h2 className={styles.pageSubtitle}>
            <T keyName="join_us.header.subtitle" />
          </h2>
          <h1 className={styles.pageTitle}>
            <T keyName="join_us.header.title" />
          </h1>
        </section>
        ...
        <section className={styles.heading}>
          <div className={styles.halfWidth}>
            <h1 className={styles.headingTitle}>
              <T keyName="join_us.build_future.title" />
            </h1>
        ...
        <section>
          <div className={styles.halfWidth}>
            <div className={`${styles.recruitmentContainer} ${styles.gradientBackground}`}>
              <h4 className={styles.recruitmentTitle}>
                <T keyName="join_us.timeline.title" />
              </h4>
              <div className={styles.recruitmentStep}>
                <h5 className={styles.recruitmentStepTitle}>
                  <T keyName="join_us.timeline.step1.title" />
                </h5>
              ...
              <div className={styles.recruitmentStep}>
                <h5 className={styles.recruitmentStepTitle}>
                  <T keyName="join_us.timeline.step2.title" />
                </h5>
                <p className={styles.recruitmentStepText}>
              ...
              <div className={styles.recruitmentStep}>
                <h5 className={styles.recruitmentStepTitle}>
                  <T keyName="join_us.timeline.step3.title" />
                </h5>
                <p className={styles.recruitmentStepText}>
              ...
              <div className={styles.recruitmentStep}>
                <h5 className={styles.recruitmentStepTitle}>
                  <T keyName="join_us.timeline.step4.title" />
                </h5>
                <p className={styles.recruitmentStepText}>
          ...
          <div className={`${styles.halfWidth} ${styles.requiredGrades}`}>
            <h4 className={`${styles.requirementTitle} ${styles.boxedText}`}>
              <T keyName="join_us.requirements.bachelor.title" />
            </h4>
            <ul className={styles.requirementPointList}>
              <li className={styles.requirementPoint}>
                <T keyName="join_us.requirements.bachelor.point1" />
              </li>
              <li className={styles.requirementPoint}>
                <T keyName="join_us.requirements.bachelor.point2" />
              </li>
            </ul>
            <h4
              className={`${styles['requirementTitle--shadow']} ${styles.boxedText} ${styles.requirementTitle}`}
            >
              <T keyName="join_us.requirements.master.title" />
            </h4>
            <div className={styles.requiredGradesContainerWhite}>
              <h5
                className={`${styles.requirementSubtitle} ${styles.boxedText} ${styles.requirementColumn}`}
              >
            ...
            <ul className={styles.requirementPointList}>
              <li className={styles.requirementPoint}>
                <T keyName="join_us.requirements.master.avg_26" />
              </li>
              <li className={styles.requirementPoint}>
            ...
            <ul className={styles.requirementPointList}>
              <li className={styles.requirementPoint}>
                <T keyName="join_us.requirements.master.avg_27" />
              </li>
            </ul>
            <p className={styles.additionalRequirement}>
              <T keyName="join_us.requirements.fluency_note_pre" />{' '}
              <span onClick={openCoursesModal} style={{ cursor: 'pointer', color: '#AEB3B9' }}>
                <T keyName="join_us.requirements.fluency_note_link" />
              </span>{' '}
              <T keyName="join_us.requirements.fluency_note_post" />
            </p>
          </div>
        </section>
        ...
        <section className={styles.spacing}>
          <div className={styles.halfWidth}>
            ...
            <ul className={styles.shortRecruitmentStepText}>
              <li>
                <T keyName="join_us.form.list.name" />
              </li>
              <li>
                <T keyName="join_us.form.list.surname" />
              </li>
              <li>
                <T keyName="join_us.form.list.email" />
              </li>
              <li>
                <T keyName="join_us.form.list.average" />
              </li>
              <li>
                <T keyName="join_us.form.list.degree" />
              </li>
            </ul>
            <p className={styles.shortRecruitmentStepText}>
              <T keyName="join_us.form.upload_note_pre" />{' '}
              <strong>
                {' '}
                <T keyName="join_us.form.upload_note_bold" />
              </strong>
              )
            </p>
          </div>
          <div className={styles.halfWidth}>
            <div className={`${styles.recruitmentContainer} ${styles.gradientBackground}`}>
              <h4 className={styles.recruitmentTitle}>
                <T keyName="join_us.exceptions.title" />
              </h4>
        ...
        {featureFlags[Feature.IsRecruitmentOpen] ? (
          ...
          <div className={styles.disabledJoinUs}>
            <div className={styles.disabledJoinUs__text}>
              <T keyName="join_us.closed.line1" />
            </div>
            <div className={styles.disabledJoinUs__text}>
              <T keyName="join_us.closed.line2" />
            </div>
          </div>
        )}
      </main>
